...
export const en = {
  ...
  services: {
    ...
    soonNote: 'We expand when a customer asks for something, not because it sounds good on a slide. The order is:',
    soon: [
      'Server and VPS monitoring',
      'Networks, NAS, routers and UPS',
      'The hardware a business depends on daily',
      'IoT and building monitoring - temperature, access, energy',
      'Hotels, warehouses and commercial property',
      'Industrial monitoring - machines, PLC, Modbus, OPC-UA',
    ],
    items: [
  ...
  */
  ...
  a11y: { skip: 'Skip to content', language: 'Language', menu: 'Menu', toTop: 'Back to top' },
};
